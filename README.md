...
<body>
    ...
    <script>
        ...
        const allQuestions = [
            // ... (جميع الأسئلة الـ 50 كما في الكود السابق)
            // لأغراض العرض، سأضيف 5 أسئلة فقط كمثال
            {
        ...
        // بيانات المتصدرين الافتراضية
        const defaultLeaderboard = [
            { name: "أحمد محمد", score: 98, section: "الشعبة 1" },
            { name: "فاطمة علي", score: 95, section: "الشعبة 3" },
            { name: "خالد إبراهيم", score: 92, section: "الشعبة 2" },
            { name: "سارة عبدالله", score: 90, section: "الشعبة 4" },
            { name: "يوسف حسن", score: 88, section: "الشعبة 5" },
            { name: "نورة سعيد", score: 85, section: "الشعبة 6" },
            { name: "محمد عبدالرحمن", score: 82, section: "الشعبة 7" },
            { name: "لمى خالد", score: 80, section: "الشعبة 1" },
            { name: "عمر ناصر", score: 78, section: "الشعبة 3" },
            { name: "ريم فيصل", score: 75, section: "الشعبة 2" }
        ];
...
<body>
    ...
    <script>
        ...
        // ... (بقية الكود يبقى كما هو مع بعض التعديلات الطفيفة)
